...
<?php
    ...
    if ($answer2 == "A") { $totalA = $totalA + 1.20; }
    ...
    if ($answer7 == "A") { $totalA = $totalA + 1.20; }
    ...
    if ($answer12 == "A") { $totalA = $totalA + 1.21; }
    ...
    if ($answer17 == "A") { $totalA = $totalA + 1.21; }
...
<?php
    ...
    if ($totalA > $totalB && $totalA > $totalC && $totalA > $totalD) {
        echo '<h1>You Are: Sasuke Uchiha</h1><img src=../images/sasuke.png></p><p></p><a href="/index.php">Play Again?</a></div>';
    }

    elseif ($totalB > $totalA && $totalB > $totalC && $totalB > $totalD) {
        echo '<h1>You Are: Zabuza Momochi</h1><img src=../images/zabuza.jpg></p><p></p><a href="/index.php">Play Again?</a></div>';
    }

    elseif ($totalC > $totalA && $totalC > $totalB && $totalC > $totalD) {
        echo '<h1>You Are: Gaara</h1><img src=../images/gaara.jpg></p><p><p></p><a href="/index.php">Play Again?</a></div>';
    }

    elseif ($totalD > $totalA && $totalD > $totalB && $totalD > $totalC) {
        echo '<h1>You Are: Naruto Uzumaki</h1><img src=../images/naruto.jpg></p><p></p><a href="/index.php">Play Again?</a></div>';
    } 
