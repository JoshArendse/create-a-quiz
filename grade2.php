...
<?php
    ...
    if ($totalA > $totalB && $totalA > $totalC && $totalA > $totalD) {
        echo '<h1>You Are: Sakura Haruno</h1><img src=../images/sakura.jpg></p><p></p><a href="/index.php">Play Again?</a></div>';
    }

    elseif ($totalB > $totalA && $totalB > $totalC && $totalB > $totalD) {
        echo '<h1>You Are: Haku</h1><img src=../images/haku.jpg></p><p></p><a href="/index.php">Play Again?</a></div>';
    }

    elseif ($totalC > $totalA && $totalC > $totalB && $totalC > $totalD) {
        echo '<h1>You Are: Temari</h1><img src=../images/temari.jpg></p><p><p></p><a href="/index.php">Play Again?</a></div>';
    }

    elseif ($totalD > $totalA && $totalD > $totalB && $totalD > $totalC) {
        echo '<h1>You Are: Hinata Hyuga</h1><img src=../images/hinata.jpg></p><p></p><a href="/index.php">Play Again?</a></div>';
    } 
